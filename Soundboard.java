...
public class Soundboard
{
	public Soundboard()
	{
		...
		JButton newJbuttonAudrey = makeSoundboardButton("audrey.jpg", "Hepburn.wav");
		
		//create the Sylvia Mathews Burwell button 
        JButton Davison = makeSoundboardButton("DavisonPic.jpg", "DavisonSound.wav");
